<template>
  <div id="trades-payment-details" class="d-flex flex-column">
    <navbar
      title="PAYMENT"
      desc="DETAILS"
      hide-append
    ...
    <v-card class="card-outline pa-4 mb-6">
...
export default {
  ...
  head() {
    const title = 'Trades payment details';
    return {
      title,
    }
  },
...
<style src="~/assets/styles/pages/trades-payment-details.scss" lang="scss" />
